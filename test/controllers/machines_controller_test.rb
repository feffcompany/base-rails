...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { arcade_id: @machine.arcade_id, game_id: @machine.game_id } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { arcade_id: @machine.arcade_id, game_id: @machine.game_id } }
