...
class ArcadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arcade" do
    assert_difference('Arcade.count') do
      post arcades_url, params: { arcade: { address: @arcade.address, comments_count: @arcade.comments_count, name: @arcade.name, owner_id: @arcade.owner_id } }
    end
  ...
  test "should update arcade" do
    patch arcade_url(@arcade), params: { arcade: { address: @arcade.address, comments_count: @arcade.comments_count, name: @arcade.name, owner_id: @arcade.owner_id } }
